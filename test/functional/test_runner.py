...
BASE_SCRIPTS= [
    ...
    'dip3-deterministicmns.py', # NOTE: needs gobyte_hash to pass
    'feature_block_reward_reallocation.py',
    'wallet-hd.py',
    'walletbackup.py',
    # vv Tests less than 5m vv
    'p2p-fullblocktest.py', # NOTE: needs gobyte_hash to pass
    ...
    'listtransactions.py',
    'multikeysporks.py',
    'llmq-signing.py', # NOTE: needs gobyte_hash to pass
    'llmq-signing.py --spork21', # NOTE: needs gobyte_hash to pass
    'llmq-chainlocks.py', # NOTE: needs gobyte_hash to pass
    'llmq-connections.py', # NOTE: needs gobyte_hash to pass
    'llmq-simplepose.py', # NOTE: needs gobyte_hash to pass
    'llmq-is-cl-conflicts.py', # NOTE: needs gobyte_hash to pass
    'llmq-is-retroactive.py', # NOTE: needs gobyte_hash to pass
    'llmq-dkgerrors.py', # NOTE: needs gobyte_hash to pass
    'dip4-coinbasemerkleroots.py', # NOTE: needs gobyte_hash to pass
    ...
    'minchainwork.py',
    'p2p-acceptblock.py', # NOTE: needs gobyte_hash to pass
    'feature_shutdown.py',
    'privatesend.py',
    'uacomment.py',
    'feature_logging.py',
