...
BASE_SCRIPTS= [
    ...
    'feature_dip3_deterministicmns.py', # NOTE: needs gobyte_hash to pass
    'feature_block_reward_reallocation.py',
    'feature_llmq_data_recovery.py',
    'wallet_hd.py',
    'wallet_backup.py',
    # vv Tests less than 5m vv
    'feature_block.py', # NOTE: needs gobyte_hash to pass
    ...
    'feature_llmq_signing.py', # NOTE: needs gobyte_hash to pass
    'feature_llmq_signing.py --spork21', # NOTE: needs gobyte_hash to pass
    'feature_llmq_chainlocks.py', # NOTE: needs gobyte_hash to pass
    'feature_llmq_connections.py', # NOTE: needs gobyte_hash to pass
    'feature_llmq_simplepose.py', # NOTE: needs gobyte_hash to pass
    'feature_llmq_is_cl_conflicts.py', # NOTE: needs gobyte_hash to pass
    'feature_llmq_is_retroactive.py', # NOTE: needs gobyte_hash to pass
    'feature_llmq_dkgerrors.py', # NOTE: needs gobyte_hash to pass
    'feature_dip4_coinbasemerkleroots.py', # NOTE: needs gobyte_hash to pass
    # vv Tests less than 60s vv
    'p2p_sendheaders.py', # NOTE: needs gobyte_hash to pass
    ...
    'p2p_unrequested_blocks.py', # NOTE: needs gobyte_hash to pass
    'feature_shutdown.py',
    'rpc_coinjoin.py',
    'rpc_masternode.py',
    'rpc_mnauth.py',
...
def main():
    ...
    tmpdir = "%s/gobyte_test_runner_%s" % (args.tmpdirprefix, datetime.datetime.now().strftime("%Y%m%d_%H%M%S"))
    os.makedirs(tmpdir)
