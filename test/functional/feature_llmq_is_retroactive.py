#!/usr/bin/env python3
# Copyright (c) 2015-2021 The GoByte Core developers
...
class LLMQ_IS_RetroactiveSigning(GoByteTestFramework):
    def set_test_params(self):
        # -whitelist is needed to avoid the trickling logic on node0
        self.set_gobyte_test_params(6, 5, [["-whitelist=127.0.0.1"], [], [], [], ["-minrelaytxfee=0.001"], ["-minrelaytxfee=0.001"]], fast_dip3_enforcement=True)
