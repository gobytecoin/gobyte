...
#ifndef GOBYTE_CRYPTO_BLS_H
#define GOBYTE_CRYPTO_BLS_H
...
// bls-gobyte uses relic, which may define DEBUG and ERROR, which leads to many warnings in some build setups
#undef ERROR
#undef DEBUG
#include <bls-gobyte/bls.hpp>
#include <bls-gobyte/elements.hpp>
#include <bls-gobyte/privatekey.hpp>
#include <bls-gobyte/schemes.hpp>
#include <bls-gobyte/threshold.hpp>
#undef DOUBLE
