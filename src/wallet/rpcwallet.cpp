...
UniValue setaccount(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 2)
        throw std::runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("setaccount", "\"Gc3k8VNYmYfr8WBBTXMBZQGHkBddPxFC8k\" \"tabby\"")
            + HelpExampleRpc("setaccount", "\"Gc3k8VNYmYfr8WBBTXMBZQGHkBddPxFC8k\", \"tabby\"")
        );
...
UniValue getaccount(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("getaccount", "\"Gc3k8VNYmYfr8WBBTXMBZQGHkBddPxFC8k\"")
            + HelpExampleRpc("getaccount", "\"Gc3k8VNYmYfr8WBBTXMBZQGHkBddPxFC8k\"")
        );
...
UniValue sendtoaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 7)
        throw std::runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("sendtoaddress", "\"Gc3k8VNYmYfr8WBBTXMBZQGHkBddPxFC8k\" 0.1")
            + HelpExampleCli("sendtoaddress", "\"Gc3k8VNYmYfr8WBBTXMBZQGHkBddPxFC8k\" 0.1 \"donation\" \"seans outpost\"")
            + HelpExampleCli("sendtoaddress", "\"Gc3k8VNYmYfr8WBBTXMBZQGHkBddPxFC8k\" 0.1 \"\" \"\" true")
            + HelpExampleRpc("sendtoaddress", "\"Gc3k8VNYmYfr8WBBTXMBZQGHkBddPxFC8k\", 0.1, \"donation\", \"seans outpost\"")
        );
...
UniValue instantsendtoaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 5)
        throw std::runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("instantsendtoaddress", "\"Gc3k8VNYmYfr8WBBTXMBZQGHkBddPxFC8k\" 0.1")
            + HelpExampleCli("instantsendtoaddress", "\"Gc3k8VNYmYfr8WBBTXMBZQGHkBddPxFC8k\" 0.1 \"donation\" \"seans outpost\"")
            + HelpExampleCli("instantsendtoaddress", "\"Gc3k8VNYmYfr8WBBTXMBZQGHkBddPxFC8k\" 0.1 \"\" \"\" true")
            + HelpExampleRpc("instantsendtoaddress", "\"Gc3k8VNYmYfr8WBBTXMBZQGHkBddPxFC8k\", 0.1, \"donation\", \"seans outpost\"")
        );
...
UniValue signmessage(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 2)
        throw std::runtime_error(
            ...
            + HelpExampleCli("signmessage", "\"Gc3k8VNYmYfr8WBBTXMBZQGHkBddPxFC8k\" \"my message\"") +
            "\nVerify the signature\n"
            + HelpExampleCli("verifymessage", "\"Gc3k8VNYmYfr8WBBTXMBZQGHkBddPxFC8k\" \"signature\" \"my message\"") +
            "\nAs json rpc\n"
            + HelpExampleRpc("signmessage", "\"Gc3k8VNYmYfr8WBBTXMBZQGHkBddPxFC8k\", \"my message\"")
        );
...
UniValue getreceivedbyaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 3)
        throw std::runtime_error(
            ...
            + HelpExampleCli("getreceivedbyaddress", "\"Gc3k8VNYmYfr8WBBTXMBZQGHkBddPxFC8k\"") +
            "\nThe amount including unconfirmed transactions, zero confirmations\n"
            + HelpExampleCli("getreceivedbyaddress", "\"Gc3k8VNYmYfr8WBBTXMBZQGHkBddPxFC8k\" 0") +
            "\nThe amount with at least 6 confirmation, very safe\n"
            + HelpExampleCli("getreceivedbyaddress", "\"Gc3k8VNYmYfr8WBBTXMBZQGHkBddPxFC8k\" 6") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("getreceivedbyaddress", "\"Gc3k8VNYmYfr8WBBTXMBZQGHkBddPxFC8k\", 6")
       );
...
UniValue sendfrom(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 3 || request.params.size() > 7)
        throw std::runtime_error(
            ...
            + HelpExampleCli("sendfrom", "\"\" \"Gc3k8VNYmYfr8WBBTXMBZQGHkBddPxFC8k\" 0.01") +
            "\nSend 0.01 from the tabby account to the given address, funds must have at least 6 confirmations\n"
            + HelpExampleCli("sendfrom", "\"tabby\" \"Gc3k8VNYmYfr8WBBTXMBZQGHkBddPxFC8k\" 0.01 6 false \"donation\" \"seans outpost\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("sendfrom", "\"tabby\", \"Gc3k8VNYmYfr8WBBTXMBZQGHkBddPxFC8k\", 0.01, 6, false, \"donation\", \"seans outpost\"")
        );
...
UniValue sendmany(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 8)
        throw std::runtime_error(
            ...
            + HelpExampleCli("sendmany", "\"tabby\" \"{\\\"Gc3k8VNYmYfr8WBBTXMBZQGHkBddPxFC8k\\\":0.01,\\\"XuQQkwA4FYkq2XERzMY2CiAZhJTEDAbtcG\\\":0.02}\"") +
            "\nSend two amounts to two different addresses setting the confirmation and comment:\n"
            + HelpExampleCli("sendmany", "\"tabby\" \"{\\\"Gc3k8VNYmYfr8WBBTXMBZQGHkBddPxFC8k\\\":0.01,\\\"XuQQkwA4FYkq2XERzMY2CiAZhJTEDAbtcG\\\":0.02}\" 6 false \"testing\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("sendmany", "\"tabby\", \"{\\\"Gc3k8VNYmYfr8WBBTXMBZQGHkBddPxFC8k\\\":0.01,\\\"XuQQkwA4FYkq2XERzMY2CiAZhJTEDAbtcG\\\":0.02}\", 6, false, \"testing\"")
        );
...
UniValue walletlock(const JSONRPCRequest& request)
{
    ...
    if (pwalletMain->IsCrypted() && (request.fHelp || request.params.size() != 0))
        throw std::runtime_error(
            ...
            + HelpExampleCli("sendtoaddress", "\"Gc3k8VNYmYfr8WBBTXMBZQGHkBddPxFC8k\" 1.0") +
