...
UniValue setaccount(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 2)
        throw std::runtime_error(
            ...
            "\nArguments:\n"
            "1. \"address\"         (string, required) The gobyte address to be associated with an account.\n"
            "2. \"account\"         (string, required) The account to assign the address to.\n"
            "\nExamples:\n"
            + HelpExampleCli("setaccount", "\"GfQoMQm5qQ9kig65EzF46pz2pnychVHPYT\" \"tabby\"")
            + HelpExampleRpc("setaccount", "\"GfQoMQm5qQ9kig65EzF46pz2pnychVHPYT\", \"tabby\"")
        );
...
UniValue getaccount(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("getaccount", "\"GfQoMQm5qQ9kig65EzF46pz2pnychVHPYT\"")
            + HelpExampleRpc("getaccount", "\"GfQoMQm5qQ9kig65EzF46pz2pnychVHPYT\"")
        );
...
UniValue sendtoaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 7)
        throw std::runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("sendtoaddress", "\"GfQoMQm5qQ9kig65EzF46pz2pnychVHPYT\" 0.1")
            + HelpExampleCli("sendtoaddress", "\"GfQoMQm5qQ9kig65EzF46pz2pnychVHPYT\" 0.1 \"donation\" \"seans outpost\"")
            + HelpExampleCli("sendtoaddress", "\"GfQoMQm5qQ9kig65EzF46pz2pnychVHPYT\" 0.1 \"\" \"\" true")
            + HelpExampleRpc("sendtoaddress", "\"GfQoMQm5qQ9kig65EzF46pz2pnychVHPYT\", 0.1, \"donation\", \"seans outpost\"")
        );
...
UniValue instantsendtoaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 5)
        throw std::runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("instantsendtoaddress", "\"GfQoMQm5qQ9kig65EzF46pz2pnychVHPYT\" 0.1")
            + HelpExampleCli("instantsendtoaddress", "\"GfQoMQm5qQ9kig65EzF46pz2pnychVHPYT\" 0.1 \"donation\" \"seans outpost\"")
            + HelpExampleCli("instantsendtoaddress", "\"GfQoMQm5qQ9kig65EzF46pz2pnychVHPYT\" 0.1 \"\" \"\" true")
            + HelpExampleRpc("instantsendtoaddress", "\"GfQoMQm5qQ9kig65EzF46pz2pnychVHPYT\", 0.1, \"donation\", \"seans outpost\"")
        );
...
UniValue listaddressbalances(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() > 1)
        throw std::runtime_error(
            ...
            "\nResult:\n"
            "{\n"
            "  \"address\": amount,       (string) The gobyte address and the amount in " + CURRENCY_UNIT + "\n"
            "  ,...\n"
            "}\n"
            "\nExamples:\n"
...
UniValue signmessage(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 2)
        throw std::runtime_error(
            ...
            + HelpExampleCli("signmessage", "\"GfQoMQm5qQ9kig65EzF46pz2pnychVHPYT\" \"my message\"") +
            "\nVerify the signature\n"
            + HelpExampleCli("verifymessage", "\"GfQoMQm5qQ9kig65EzF46pz2pnychVHPYT\" \"signature\" \"my message\"") +
            "\nAs json rpc\n"
            + HelpExampleRpc("signmessage", "\"GfQoMQm5qQ9kig65EzF46pz2pnychVHPYT\", \"my message\"")
        );
...
UniValue getreceivedbyaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 3)
        throw std::runtime_error(
            ...
            + HelpExampleCli("getreceivedbyaddress", "\"GfQoMQm5qQ9kig65EzF46pz2pnychVHPYT\"") +
            "\nThe amount including unconfirmed transactions, zero confirmations\n"
            + HelpExampleCli("getreceivedbyaddress", "\"GfQoMQm5qQ9kig65EzF46pz2pnychVHPYT\" 0") +
            "\nThe amount with at least 6 confirmation, very safe\n"
            + HelpExampleCli("getreceivedbyaddress", "\"GfQoMQm5qQ9kig65EzF46pz2pnychVHPYT\" 6") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("getreceivedbyaddress", "\"GfQoMQm5qQ9kig65EzF46pz2pnychVHPYT\", 6")
       );
...
UniValue sendfrom(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 3 || request.params.size() > 7)
        throw std::runtime_error(
            ...
            + HelpExampleCli("sendfrom", "\"\" \"GfQoMQm5qQ9kig65EzF46pz2pnychVHPYT\" 0.01") +
            "\nSend 0.01 from the tabby account to the given address, funds must have at least 6 confirmations\n"
            + HelpExampleCli("sendfrom", "\"tabby\" \"GfQoMQm5qQ9kig65EzF46pz2pnychVHPYT\" 0.01 6 false \"donation\" \"seans outpost\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("sendfrom", "\"tabby\", \"GfQoMQm5qQ9kig65EzF46pz2pnychVHPYT\", 0.01, 6, false, \"donation\", \"seans outpost\"")
        );
...
UniValue sendmany(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 8)
        throw std::runtime_error(
            ...
            "    {\n"
            "      \"address\":amount     (numeric or string) The gobyte address is the key, the numeric amount (can be string) in " + CURRENCY_UNIT + " is the value\n"
            "      ,...\n"
            "    }\n"
            ...
            + HelpExampleCli("sendmany", "\"tabby\" \"{\\\"GfQoMQm5qQ9kig65EzF46pz2pnychVHPYT\\\":0.01,\\\"GQ6aNa6cpNDxX8RD13jDwf5KdaDupKKVZi\\\":0.02}\"") +
            "\nSend two amounts to two different addresses setting the confirmation and comment:\n"
            + HelpExampleCli("sendmany", "\"tabby\" \"{\\\"GfQoMQm5qQ9kig65EzF46pz2pnychVHPYT\\\":0.01,\\\"GQ6aNa6cpNDxX8RD13jDwf5KdaDupKKVZi\\\":0.02}\" 6 false \"testing\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("sendmany", "\"tabby\", \"{\\\"GfQoMQm5qQ9kig65EzF46pz2pnychVHPYT\\\":0.01,\\\"GQ6aNa6cpNDxX8RD13jDwf5KdaDupKKVZi\\\":0.02}\", 6, false, \"testing\"")
        );
...
UniValue addmultisigaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 3)
    {
        std::string msg = "addmultisigaddress nrequired [\"key\",...] ( \"account\" )\n"
            ...
            "\nResult:\n"
            "\"address\"         (string) A gobyte address associated with the keys.\n"
...
UniValue walletlock(const JSONRPCRequest& request)
{
    ...
    if (pwalletMain->IsCrypted() && (request.fHelp || request.params.size() != 0))
        throw std::runtime_error(
            ...
            + HelpExampleCli("sendtoaddress", "\"GfQoMQm5qQ9kig65EzF46pz2pnychVHPYT\" 1.0") +
...
UniValue encryptwallet(const JSONRPCRequest& request)
{
    ...
    StartShutdown();
    return "Wallet encrypted; GoByte Core server stopping, restart to run with encrypted wallet. The keypool has been flushed and a new HD seed was generated (if you are using HD). You need to make a new backup.";
}
...
UniValue getwalletinfo(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 0)
        throw std::runtime_error(
            ...
            + (!fLiteMode ?
            "  \"privatesend_balance\": xxxxxx, (numeric) the anonymized gobyte balance of the wallet in " + CURRENCY_UNIT + "\n" : "") +
...
UniValue listunspent(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() > 4)
        throw std::runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("listunspent", "")
            + HelpExampleCli("listunspent", "6 9999999 \"[\\\"GfQoMQm5qQ9kig65EzF46pz2pnychVHPYT\\\",\\\"GQ6aNa6cpNDxX8RD13jDwf5KdaDupKKVZi\\\"]\"")
            + HelpExampleRpc("listunspent", "6, 9999999 \"[\\\"GfQoMQm5qQ9kig65EzF46pz2pnychVHPYT\\\",\\\"GQ6aNa6cpNDxX8RD13jDwf5KdaDupKKVZi\\\"]\"")
        );
    ...
    if (request.params.size() > 1) {
      if (request.params[1].type() == UniValue::VBOOL) {
        ...
        if (options.exists("changeAddress")) {
            ...
            if (!address.IsValid())
                throw JSONRPCError(RPC_INVALID_PARAMETER, "changeAddress must be a valid gobyte address");
