...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s gobyte-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  gobyte-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded dash transaction") + "\n" +
              "  gobyte-tx [options] -create [commands]   " + _("Create hex-encoded dash transaction") + "\n" +
              "\n";
