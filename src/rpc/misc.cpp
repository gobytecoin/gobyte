...
UniValue validateaddress(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "}\n"
            "\nExamples:\n"
            + HelpExampleCli("validateaddress", "\"GfQoMQm5qQ9kig65EzF46pz2pnychVHPYT\"")
            + HelpExampleRpc("validateaddress", "\"GfQoMQm5qQ9kig65EzF46pz2pnychVHPYT\"")
        );
...
UniValue verifymessage(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 3)
        throw std::runtime_error(
            ...
            "\nAs json rpc\n"
            + HelpExampleRpc("verifymessage", "\"GfQoMQm5qQ9kig65EzF46pz2pnychVHPYT\", \"signature\", \"my message\"")
        );
...
UniValue getaddressmempool(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressmempool", "'{\"addresses\": [\"GfQoMQm5qQ9kig65EzF46pz2pnychVHPYT\"]}'")
            + HelpExampleRpc("getaddressmempool", "{\"addresses\": [\"GfQoMQm5qQ9kig65EzF46pz2pnychVHPYT\"]}")
        );
...
UniValue getaddressutxos(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressutxos", "'{\"addresses\": [\"GfQoMQm5qQ9kig65EzF46pz2pnychVHPYT\"]}'")
            + HelpExampleRpc("getaddressutxos", "{\"addresses\": [\"GfQoMQm5qQ9kig65EzF46pz2pnychVHPYT\"]}")
        );
...
UniValue getaddressdeltas(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1 || !request.params[0].isObject())
        throw std::runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressdeltas", "'{\"addresses\": [\"GfQoMQm5qQ9kig65EzF46pz2pnychVHPYT\"]}'")
            + HelpExampleRpc("getaddressdeltas", "{\"addresses\": [\"GfQoMQm5qQ9kig65EzF46pz2pnychVHPYT\"]}")
        );
...
UniValue getaddressbalance(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "}\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddressbalance", "'{\"addresses\": [\"GfQoMQm5qQ9kig65EzF46pz2pnychVHPYT\"]}'")
            + HelpExampleRpc("getaddressbalance", "{\"addresses\": [\"GfQoMQm5qQ9kig65EzF46pz2pnychVHPYT\"]}")
        );
...
UniValue getaddresstxids(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "]\n"
            "\nExamples:\n"
            + HelpExampleCli("getaddresstxids", "'{\"addresses\": [\"GfQoMQm5qQ9kig65EzF46pz2pnychVHPYT\"]}'")
            + HelpExampleRpc("getaddresstxids", "{\"addresses\": [\"GfQoMQm5qQ9kig65EzF46pz2pnychVHPYT\"]}")
        );
