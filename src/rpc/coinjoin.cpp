...
UniValue getcoinjoininfo(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 0) {
        throw std::runtime_error(
            ...
            "  \"max_amount\": xxx,                 (numeric) Target CoinJoin balance in " +
            CURRENCY_UNIT + "\n"
            ...
            CURRENCY_UNIT + "\n"
                            ...
                            "}\n"
                            "\nExamples:\n" +
            HelpExampleCli("getcoinjoininfo", "") + HelpExampleRpc("getcoinjoininfo", ""));
    }
...
static const CRPCCommand commands[] =
    {
        ...
        //  --------------------- ------------------------  ---------------------------------
        {"gobyte", "getpoolinfo", &getpoolinfo, {}},
        {"gobyte", "getcoinjoininfo", &getcoinjoininfo, {}},
#ifdef ENABLE_WALLET
        {"gobyte", "coinjoin", &coinjoin, {}},
#endif // ENABLE_WALLET
};
