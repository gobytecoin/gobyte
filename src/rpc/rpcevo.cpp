...
// Allows to specify GoByte address or priv key. In case of GoByte address, the priv key is taken from the wallet
...
void protx_update_registrar_help()
{
    throw std::runtime_error(
            ...
            "\"txid\"                        (string) The transaction id.\n"
            "\nExamples:\n"
            + HelpExampleCli("protx", "update_registrar \"0123456701234567012345670123456701234567012345670123456701234567\" \"982eb34b7c7f614f29e5c665bc3605f1beeef85e3395ca12d3be49d2868ecfea5566f11cedfad30c51b2403f2ad95b67\" \"Gc3k8VNYmYfr8WBBTXMBZQGHkBddPxFC8k\"")
    );
}
