...
void PaymentServer::handleURIOrFile(const QString& s)
{
    ...
    if (s.startsWith("gobyte://", Qt::CaseInsensitive)) {
        Q_EMIT message(tr("URI handling"), tr("'gobyte://' is not a valid URI. Use 'gobyte:' instead."),
            CClientUIInterface::MSG_ERROR);
    } else if (s.startsWith(BITCOIN_IPC_PREFIX, Qt::CaseInsensitive)) // gobyte: URI
    {
