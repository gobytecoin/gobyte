    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("GoByte Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About GoByte Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  gobyte-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the GoByte in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 GBX, 0.1 GBX, 1 GBX, and 10 GBX--sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://gobytecoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://gobytecoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("GoByte Core is shutting down...") + "<br /><br />" +
