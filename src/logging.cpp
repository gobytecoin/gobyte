...
bool GetLogCategory(uint64_t* f, const std::string* str)
{
    if (f && str) {
        ...
        if (*str == "gobyte") {
            *f = BCLog::CHAINLOCKS | BCLog::GOBJECT | BCLog::INSTANTSEND | BCLog::KEEPASS | BCLog::LLMQ | BCLog::LLMQ_DKG | BCLog::LLMQ_SIGS | BCLog::MNPAYMENTS | BCLog::MNSYNC | BCLog::COINJOIN | BCLog::SPORK;
            return true;
        }
