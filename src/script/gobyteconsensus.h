...
enum
{
    ...
    gobyteconsensus_SCRIPT_FLAGS_VERIFY_ALL                 = gobyteconsensus_SCRIPT_FLAGS_VERIFY_P2SH | gobyteconsensus_SCRIPT_FLAGS_VERIFY_DERSIG |gobyteconsensus_SCRIPT_FLAGS_VERIFY_CHECKLOCKTIMEVERIFY |
