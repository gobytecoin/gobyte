...
#ifndef BITCOIN_SCRIPT_GOBYTECONSENSUS_H
#define BITCOIN_SCRIPT_GOBYTECONSENSUS_H
...
EXPORT_SYMBOL int gobyteconsensus_verify_script(const unsigned char* scriptPubKey, unsigned int scriptPubKeyLen, const unsigned char* txTo, unsigned int txToLen, unsigned int nIn, unsigned int flags, gobyteconsensus_error* err);
...
#endif // BITCOIN_SCRIPT_GOBYTECONSENSUS_H
