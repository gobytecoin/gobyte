...
//! Interface for the src/evo part of a gobyte node (gobyted process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/llmq part of a gobyte node (gobyted process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a gobyte node (gobyted process).
...
//! Top-level interface for a gobyte node (gobyted process).
class Node
{
public:
    virtual ~Node() {}
