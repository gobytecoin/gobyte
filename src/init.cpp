...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-privatesendamount=<n>", strprintf(_("Keep N GBX anonymized (%u-%u, default: %u)"), MIN_PRIVATESEND_AMOUNT, MAX_PRIVATESEND_AMOUNT, DEFAULT_PRIVATESEND_AMOUNT));
...
std::string LicenseInfo()
{
    ...
    return CopyrightHolders(_("Copyright (C)"), 2017, COPYRIGHT_YEAR) + "\n" +
           ...
           strprintf(_("Distributed under the MIT software license, see the accompanying file %s or %s"), "COPYING", "<http://www.opensource.org/licenses/mit-license.php>") + "\n" +
           "\n" +
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    // lite mode disables all GoByte-specific functionality
    ...
    // ********************************************************* Step 11c: schedule GoByte-specific tasks
