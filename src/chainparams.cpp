...
public:
    CMainParams() {
        ...
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0003].nStartTime = 1564646400; // Aug 1st, 2019
        consensus.vDeployments[Consensus::DEPLOYMENT_DIP0003].nTimeout = 1596268800; // Aug 1st, 2020
        ...
        // zealousWang todo: update vSporkAddresses 
        ...
        // zealousWang todo: update chainTxData 
        chainTxData = ChainTxData{
            1547875545, // * UNIX timestamp of last known number of transactions
            445996,    // * total number of transactions between genesis and that timestamp
...
public:
    CDevNetParams() {
        ...
        // zealousWang todo: update chainTxData
        chainTxData = ChainTxData{
            1524132951, // * UNIX timestamp of devnet genesis block
            10485,                            // * we only have 2 coinbase transactions when a devnet is started up
            500                         // * estimated number of transactions per second
        };
    }
...
public:
    CRegTestParams() {
        ...
        // zealousWang todo: update privKey & vSporkAddresses 
