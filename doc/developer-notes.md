...
GoByte Core is a multithreaded application, and deadlocks or other multithreading bugs
...
be sent upstream but bugfixes may also be prudent to PR against GoByte Core so that they can be integrated
