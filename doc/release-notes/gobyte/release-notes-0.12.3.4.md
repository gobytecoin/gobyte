...
When deployed on testnet, it is required to start with a fresh data directory or call GoByte Core with `-reindex-chainstate`.

0.12.3.4 Change log
===================

See detailed [set of changes](https://github.com/gobytecoin/gobyte/compare/v0.12.3.3...gobytecoin:v0.12.3.4).
