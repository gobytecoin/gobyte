...
Release is now available from:
  ...
  <https://github.com/gobytecoin/gobyte/releases>
...
- [`9901cf433`] Fix for gobyte-qt issue with startup and multiple monitors. (#1461)
...
- [`b0843c397`] Backport Bincoin PR#7348: MOVE ONLY: move rpc* to rpc/ + same for GoByte-specific rpc (#1502)
...
- [`b9c67258b`] Backport Bitcoin PR#9609: net: fix remaining net assertions (#1575) + GoByteify
...
- [`753b1e486`] Eliminate remaining uses of g_connman in GoByte-specific code. (#1635)
...
- [`4df8a20f9`] Fix windows installer script, should handle `gobyte:` uri correctly now (#1550)
...
- [`7ab175a8e`] Ensure GoByte wallets < 0.12.2 can't open HD wallets (#1638)
...
- [`7a5943c3a`] Merge pull request #1431 from gobytecoin/v0.12.2.x-merge_upstream
- [`8bbcf6200`] Fixed pow (test and algo) (#1415)
- [`f3b92a95d`] c++11: don't throw from the reverselock destructor (#1421)
- [`b40f8f333`] Rename bitcoinconsensus library to gobyteconsensus. (#1432)
...
- [`715504357`] GoByteify bitcoin unix executables (#1486)
