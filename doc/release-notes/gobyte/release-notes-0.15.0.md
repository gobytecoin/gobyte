...
- [`dbbc51121`](https://github.com/dashpay/dash/commit/dbbc51121) Add `automake` package to gobyte-win-signer's packages list (#3307)
...
- [`737ac967f`](https://github.com/dashpay/dash/commit/737ac967f) Refactor some GoByte-specific `wait_for*` functions in tests (#3122)
