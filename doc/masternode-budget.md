...
Format: ```mngovernance prepare proposal-name url payment-count block-start gobyte-address monthly-payment-dash```
...
Format: ```mngovernance submit proposal-name url payment-count block-start gobyte-address monthly-payment-dash fee-tx```
