...
The GoByte Core daemon can be configured to act as a trusted "border
router", implementing the gobyte wire protocol and relay, making
...
The ZeroMQ feature in GoByte Core requires ZeroMQ API version 4.x or
