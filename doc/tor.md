...
1. Run GoByte Core behind a Tor proxy
----------------------------------

The first step is running GoByte Core behind a Tor proxy. This will already make all
...
port 9050 and only allows .onion nodes to connect:
	...
	./gobyted -onion=127.0.0.1:9050 -onlynet=tor -listen=0 -addnode=ssapp53tmftyjmjb.onion

In a typical situation, this suffices to run behind a Tor proxy:

	./gobyted -proxy=127.0.0.1:9050


2. Run a GoByte Core hidden server
-------------------------------
...
your gobyted's P2P listen port (9999 by default).
	...
	-externalip=X   You can tell GoByte Core about its publicly reachable address using
	                ...
	                /var/lib/tor/gobytecore-service/hostname. Onion addresses are given
...
In a typical situation, where you're only reachable via Tor, this should suffice:
	...
	./gobyted -proxy=127.0.0.1:9050 -externalip=ssapp53tmftyjmjb.onion -listen

(obviously, replace the Onion address with your own). It should be noted that you still
listen on all devices and another node could establish a clearnet connection, when knowing
your address. To mitigate this, additionally bind the address of your Tor proxy:

	./gobyted ... -bind=127.0.0.1
...
for normal IPv4/IPv6 communication, use:
	...
	./gobyted -onion=127.0.0.1:9050 -externalip=ssapp53tmftyjmjb.onion -discover


3. List of known GoByte Core Tor relays
------------------------------------
...
GoByte Core automatically creates a hidden service to listen on, without
manual configuration. This will positively affect the number of available
.onion nodes.

This new feature is enabled by default if GoByte Core is listening, and
