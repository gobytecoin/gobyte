...
*Setup instructions for a Gitian build of GoByte Core using a Debian VM or physical system.*
...
in the GoByte Core repository under 'Fetch and build inputs' to install sources which require
...
Gitian builds' in [doc/release-process.md](release-process.md#perform-gitian-builds) in the GoByte Core repository.
...
BTCPATH=/some/root/path/gobyte.git
SIGPATH=/some/root/path/gobyte-detached-sigs.git
