...
Only requiring some minor changes is gobyte.cpp.
...
Changes to gobyte.cpp
----------------------
gobyte.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
